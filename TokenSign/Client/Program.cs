...
namespace Client
{
    class Program
    {
        ...
        {
            string  staffId=(AppSettingsConfig.StaffId);
            ...
            var product2 = WebApiHelper.Post<ProductResultMsg>("http://localhost:14826/api/product/AddProudct", JsonConvert.SerializeObject(product), staffId);
            Console.Read();
        }
    }
}
